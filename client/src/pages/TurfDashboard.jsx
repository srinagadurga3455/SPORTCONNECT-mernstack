    ...
    <>
      ...
      <div className="dashboard-bg">
        <div className="container py-5">
                ...
                <div className="flex-grow-1">
                  {!user?.verificationData ? (
                    <>
                      ...
                      <p className="mb-2">Your turf is not verified. Players can only book verified turfs.</p>
                    ...
                    <>
                      ...
                      <p className="mb-0">Verify your turf facility to start receiving bookings from players.</p>
                    </>
                  )}
                </div>
                {!isPending && (
          ...
          <div className="welcome-header mb-5">
            <div className="row align-items-center">
              <div className="col-md-8">
                ...
                <p className="lead text-muted">Manage your sports facility efficiently</p>
              </div>
              <div className="col-md-4 text-end">
                <div className="profile-badge">
                  <div className="profile-icon">{user?.firstName?.charAt(0)}</div>
                  <div className="ms-3">
                    <div className="fw-bold">{user?.turf_name || user?.firstName}</div>
                    <div className="text-muted small">Turf Owner</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row g-4 mb-5">
            ...
            <div className="col-md-3">
              <div className="stat-card stat-card-green">
                ...
                <div className="stat-content">
                  <h3 className="stat-value">{todayBookings.length}</h3>
            ...
            <div className="col-md-3">
              <div className="stat-card stat-card-blue">
                ...
                <div className="stat-content">
                  <h3 className="stat-value">4.6</h3>
          ...
          {/* Turf Information */}
          <div className="turf-info-card mb-5">
            <h4>
            ...
            <div className="info-grid">
              <div className="info-item">
                ...
                <div className="info-content">
                  <h6>Turf Name</h6>
                  <p>{user?.turf_name || "Not specified"}</p>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div className="info-content">
                  <h6>Location</h6>
                  <p>{user?.turf_address || "Not specified"}</p>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div className="info-content">
                  <h6>PIN Code</h6>
                  <p>{user?.pin_code || "Not specified"}</p>
                </div>
              </div>
            ...
            <div className="mt-4">
              ...
              <div>
                {(user?.available_sports || []).map((sport, i) => (
                  <span key={i} className="sport-tag">
                    {sport}
                  </span>
                ))}
                {(!user?.available_sports || user.available_sports.length === 0) && (
                  <span className="text-muted">No sports specified</span>
                )}
              </div>
            </div>
          </div>
